...
public class Card implements Listable{
	...
	/**
	 * Returns a string representation of the Filename for the Card instance based on the value and suit of the card.
	 * Does not include any file extensions so will have to add this at the top level.
	 * @return string the filename in the form Sn, where S = the suit code as defined above 
	 * and n = the int value of the card.
	 */
	public String getFileName(){
		return suite + Integer.toString(value);
	}
