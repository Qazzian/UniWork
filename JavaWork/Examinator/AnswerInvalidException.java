/**
 * An exception for when a particular Answer is not valid for a 
...
public class AnswerInvalidException extends AnswerException
{
	public AnswerInvalidException()
	{
		super("The Answer is invalid!");
	}
	
	public AnswerInvalidException(String s)
	{
		super(s);
	}
}